...
<nav>
    <div class="container-fluid div3-1">
        ...
        <div class="div3-2">
            <a href="./index.jsp">
                <img src="img/img4/index.png" alt="" style="height: 24px;" >
            </a>
        </div>
        <ul>
            <li class="li3-1">
                <!--target=_blank用一个新网页打开超链接  -->
                <a href="./phone.jsp" target=_blank >手机</a>
                <!-- 下拉栏 -->
                <div class="xia">
                    <div class="container-fluid">
                        <ul style="text-align: center;">
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/meizu18taxue.png" alt="">
                                    <p>魅族 18「踏雪」</p>
                                    <p>￥3999</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/meizu18dengfeng.png" alt="">
                                    <p>魅族 18「等风」</p>
                                    <p>￥3999</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/meizu18duhai.png" alt="">
                                    <p>魅族 18「渡海」</p>
                                    <p>￥3999</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/meizu18pro1.png" alt="">
                                    <p>魅族 18 Pro「飞雪流光」</p>
                                    <p>￥4999</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/meizu18pro2.png" alt="">
                                    <p>魅族 18 Pro「苍穹浩瀚」</p>
                                    <p>￥4999</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/meizu18pro3.png" alt="">
                                    <p>魅族 18 Pro「银河秘境」</p>
                                    <p>￥4999</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/meizu171.png" alt="">
                                    <p>魅族 17</p>
                                    <p>￥3699</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/meizu17pro1.png" alt="">
                                    <p>魅族 17 Pro</p>
                                    <p>￥4299</p>
                                </a>
                            </li>
            ...
            <li  class="li3-1">
                <a href="./lipro.jsp" target=_blank>Lipro</a>
                <!-- 下拉栏 -->
                <div class="xia">
                    <div class="container-fluid">
                        <ul style="text-align: center;">
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/liproxia1.jpg" alt="">
                                    <p>魅族 Lipro LED 灯泡</p>
                                    <p>￥44.1</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/liproxia2.png" alt="">
                                    <p>【新品】Lipro LED 射灯</p>
                                    <p>￥299</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/liproxia3.png" alt="">
                                    <p>【新品】Lipro LED 射灯</p>
                                    <p>￥129</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/liproxia4.png" alt="">
                                    <p>【新品】Lipro LED 智...</p>
                                    <p>￥499</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/liproxia5.png" alt="">
                                    <p>魅族 Lipro LED 简灯</p>
                                    <p>￥99</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/liproxia6.png" alt="">
                                    <p>Lipro 可控硅...</p>
                                    <p>￥199</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/liproxia7.png" alt="">
                                    <p>Lipro 智能蓝牙控制器</p>
                                    <p>￥89 起</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/liproxia8.png" alt="">
                                    <p>【无线版】魅族 Lipro L...</p>
                                    <p>￥4299</p>
                                </a>
                            </li>
            ...
            <li  class="li3-1">
                <a href="./acoustics.jsp" target=_blank>声学</a>
                <!-- 下拉栏 -->
                <div class="xia">
                    <div class="container-fluid">
                        <ul style="text-align: center;">
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/shengxuexia1.png" alt="">
                                    <p>【新品】魅族 POP Pro...</p>
                                    <p>￥439</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/shengxuexia2.png" alt="">
                                    <p>魅族 POP2s 真无线耳机</p>
                                    <p>￥219</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/shengxuexia3.png" alt="">
                                    <p>魅族 HD60 降噪耳机</p>
                                    <p>￥799</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/shengxuexia4.png" alt="">
                                    <p>魅族 HD60 头戴式蓝牙...</p>
                                    <p>￥319</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/shengxuexia5.png" alt="">
                                    <p>魅族 HIFI 解码耳放</p>
                                    <p>￥129</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/shengxuexia6.png" alt="">
                                    <p>魅族 EP3C 耳机</p>
                                    <p>￥129</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/shengxuexia7.png" alt="">
                            ...
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/shengxuexia8.png" alt="">
                                    <p>MEIZU UR 高端定制耳...</p>
                                    <p>￥200</p>
                                </a>
                            </li>
            ...
            <li  class="li3-1">
                <a href="./peijian.jsp" target=_blank>配件</a>
                <!-- 下拉栏 -->
                <div class="xia">
                    <div class="container-fluid">
                        <ul style="text-align: center;">
            ...
            <li  class="li3-1">
                <a href="./shenghuo.jsp" target=_blank>生活</a>
                <!-- 下拉栏 -->
                <div class="xia">
                    <div class="container-fluid">
                        <ul style="text-align: center;">
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/shenghuoxia1.png" alt="">
                                    <p>【新品】FLYME 九周年...</p>
                                    <p>￥129</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/shenghuoxia2.png" alt="">
                                    <p>PANDAER 「龍」T恤</p>
                                    <p>￥129</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/shenghuoxia3.png" alt="">
                                    <p>PANDAER 「龍」T恤</p>
                                    <p>￥129</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/shenghuoxia4.png" alt="">
                                    <p>PANDAER 18 系列T恤</p>
                                    <p>￥129</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/shenghuoxia5.png" alt="">
                            ...
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/shenghuoxia6.png" alt="">
                                    <p>魅族防飞溅声波电动牙刷</p>
                                    <p>￥239</p>
                                </a>
                            </li>
                            <li class="li3-2">
                                <a href="">
                                    <img src="img/img4/shenghuoxia7.png" alt="">
                                    <p>魅族声波电动牙刷刷头</p>
                                    <p>￥59</p>
                                </a>
                            </li>
            ...
            <li  class="li3-1">
                <a href="./Flyme.jsp" target=_blank>Flyme</a>
            </li>
            <li  class="li3-1">
                <a href="./fuwu.jsp" target=_blank>服务</a>
            </li>
            <li  class="li3-1">
                <a href="./zhuanmaidian.jsp" target=_blank>专卖店</a>
            </li>
            <li  class="li3-1">
                <a href="./shequ.jsp" target=_blank>社区</a>
            </li>
            <li  class="li3-1">
                <a href="./qiyefuwu.jsp" target=_blank>企业服务</a>
            </li>
            <li  class="li3-1">
                <a href="">App下载</a>
                <!-- 下拉栏 -->
                <div class="xia-2">
                    <div class="container-fluid">
                        <img src="img/img4/20dbe12b-c97c-4556-ac76-bce1d6457a6a.jpg" alt="" style="height: 350px; ">
                    </div>
                </div>
            </li>
        </ul>
        ...
        <div class="navbar-header div3-4" style="margin-top: 13px;">
            <a class="navbar-brand login3-1" href="#">
                ...
                <!-- 下拉栏 -->
                <div class="xia-3">
                    <a href="./login.jsp" target=_blank>立即登录</a>
                    <a href="./register.jsp" target=_blank>立即注册</a>
                    <a href="" target=_blank>我的订单</a>
                    <a href="./mma.jsp" target=_blank style="padding-left: 30px;">M码通道</a>
                </div>
            </a>
        </div>
        <div class="navbar-header div3-4" style="margin-top: 13px;">
...
<div id="carousel-example-generic" class="carousel slide div3-3" data-ride="carousel" >
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="img/img4/download.jpg" alt="图片加载失败">
        </div>
        <div class="item">
            <img src="img/img4/lunbo1.jfif" alt="图片加载失败">
        </div>
        <div class="item">
            <img src="img/img4/lunbo2.jfif" alt="图片加载失败">
        </div>
        <div class="item">
            <img src="img/img4/lunbo3.jfif" alt="图片加载失败">
        </div>
        <div class="item">
            <img src="img/img4/lunbo4.jfif" alt="图片加载失败">
        </div>
        <div class="item">
            <img src="img/img4/lunbo5.jfif" alt="图片加载失败">
        </div>
        <div class="item">
            <img src="img/img4/lunbo6.jfif" alt="图片加载失败">
        </div>
        <div class="item">
            <img src="img/img4/lunbo7.jfif" alt="图片加载失败">
        </div>
    </div>
</div>
...
<div class="container-fluid">
    <img src="img/img4/meizu18.png" alt="" width="100%" >
</div>
<div class="container-fluid" style="background-color: rgb(244, 244, 244);">
    <div class="container">
        <div class="row div3-7">
            <div class="col-md-6" >
                <a href="" >
                    ...
                    <img src="img/img4/xiazaimeizu18.png" alt="" width="460px">
                </a>
            </div>
            <div class="col-md-6">
                <a href="" >
        ...
        <div class="row div3-7">
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/xiaolong865.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/songshengrumo.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/dinbai.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/wujin.png" alt="" width="230px" >
...
<div class="container-fluid">
    <img src="img/img4/meizushoubiao.png" alt="" width="100%" >
</div>
<div class="container-fluid" style="background-color: rgb(244, 244, 244);">
    <div class="container">
        <div class="row div3-7">
            <div class="col-md-3">
                <a href="" style="background-image: url(img/img4/chongdianbao.png);background-size: 100%; height: 296px;" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/quanzhinengshoubiao.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/baohuke.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/xiaribaohuke.png" alt="" width="230px" >
        ...
        <div class="row div3-7">
            <div class="col-md-3">
                <a href="" style="background-image: url(img/img4/wuxianchong.png);background-size: 100%; height: 296px;" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/chongdiantou.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/moshake.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/baohumo.png" alt="" width="230px" >
        ...
        <div class="row div3-7">
            <div class="col-md-3">
                <a href="" style="background-image: url(img/img4/guijiaoke.png);background-size: 100%; height: 296px;" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/dianduke.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/lvseguijiaoke.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/USBxian.png" alt="" width="230px" >
        ...
        <div class="row div3-7">
            <div class="col-md-3">
                <a href="" style="background-image: url(img/img4/guiijaokemanhe.png);background-size: 100%; height: 296px;" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/Type-cxian.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/type-cbaixian.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/kuaichongxian.png" alt="" width="230px" >
...
<div class="container-fluid">
    <img src="img/img4/01meizushengxue/banner.jpg" alt="" width="100%" >
</div>
<div class="container-fluid" style="background-color: rgb(244, 244, 244);">
    <div class="container">
        <div class="row div3-7">
            <div class="col-md-3">
                <a href="" style="background-image: url(img/img4/01meizushengxue/001.jpg);background-size: 100%; height: 296px;" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/01meizushengxue/002.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/01meizushengxue/003.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/01meizushengxue/004.png" alt="" width="230px" >
        ...
        <div class="row div3-7">
            <div class="col-md-3">
                <a href="" style="background-image: url(img/img4/01meizushengxue/005.jpg);background-size: 100%; height: 296px;" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/01meizushengxue/006.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/01meizushengxue/007.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/01meizushengxue/008.png" alt="" width="230px" >
...
<div class="container-fluid">
    <img src="img/img4/02Lipro/banner.jpg" alt="" width="100%" >
</div>
<div class="container-fluid" style="background-color: rgb(244, 244, 244);">
    <div class="container">
        <div class="row div3-7">
            <div class="col-md-3">
                <a href="" style="background-image: url(img/img4/02Lipro/001.jpg);background-size: 100%; height: 296px;" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/02Lipro/002.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/02Lipro/003.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/02Lipro/004.png" alt="" width="230px" >
        ...
        <div class="row div3-7">
            <div class="col-md-3">
                <a href="" style="background-image: url(img/img4/02Lipro/005.jpg);background-size: 100%; height: 296px;" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/02Lipro/006.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/02Lipro/007.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/02Lipro/008.png" alt="" width="230px" >
        ...
        <div class="row div3-7">
            <div class="col-md-3">
                <a href="" style="background-image: url(img/img4/02Lipro/009.jpg);background-size: 100%; height: 296px;" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/02Lipro/010.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/02Lipro/011.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/02Lipro/012.png" alt="" width="230px" >
...
<div class="container-fluid">
    <img src="img/img4/03shenghuo/banner.jpg" alt="" width="100%" >
</div>
<div class="container-fluid" style="background-color: rgb(244, 244, 244);">
    <div class="container">
        <div class="row div3-7">
            <div class="col-md-3">
                <a href="" style="background-image: url(img/img4/03shenghuo/001.jpg);background-size: 100%; height: 296px;" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/03shenghuo/002.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/03shenghuo/003.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/03shenghuo/004.png" alt="" width="230px" >
                    <span class="span3-1">PANDAER「龍」T恤</span>
                    <span class="span3-3">【满200减20】极光印花|丝绸手感|无毛刺</span>
                    <span class="span3-2">￥129</span>
                </a>
        ...
        <div class="row div3-7">
            <div class="col-md-3">
                <a href="" style="background-image: url(img/img4/03shenghuo/005.jpg);background-size: 100%; height: 296px;" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/03shenghuo/006.jpg" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/03shenghuo/007.png" alt="" width="230px" >
            ...
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/03shenghuo/008.png" alt="" width="230px" >
...
<div class="container-fluid" style="background-color: rgb(244, 244, 244);">
    <div class="container">
        <div class="row div3-7">
            <div class="col-md-6">
                <a href="" style="background-image: url(img/img4/04Flyme/001.png);background-size: 100%; height: 245px;" >
                </a>
            </div>

            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/04Flyme/002.jpg" alt="" width="262.5px" >
                    <span class="span3-7">Flyme 隐私安全白皮书</span>
                </a>
            </div>
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/04Flyme/003.jpg" alt="" width="262.5px" >
        ...
        <div class="row div3-7">
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/04Flyme/004.png" alt="" width="262.5px" >
                    <span class="span3-7">全新导入滤镜</span>
                </a>
            </div>
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/04Flyme/005.png" alt="" width="262.5px" >
                    <span class="span3-7">全面提升续航能力</span>
                </a>
            </div>
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/04Flyme/006.jpg" alt="" width="262.5px" >
                    <span class="span3-7">不得不知的小功能</span>
                </a>
            </div>
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/04Flyme/007.jpg" alt="" width="262.5px" >
...
<div class="container-fluid" style="background-color: rgb(244, 244, 244); padding-bottom: 50px;" >
    <div class="container">
        <div class="row div3-7">
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/05shipin/001.jpg" alt="" width="262.5px" >
                    <span class="span3-7">魅族 18 Pro</span>
                </a>
            </div>
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/05shipin/002.jpg" alt="" width="262.5px" >
                    <span class="span3-7">魅族 18</span>
                </a>
            </div>
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/05shipin/003.jpg" alt="" width="262.5px" >
                    <span class="span3-7">这十八年</span>
                </a>
            </div>
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/05shipin/004.jpg" alt="" width="262.5px" >
        ...
        <div class="row div3-7">
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/05shipin/005.jpg" alt="" width="262.5px" >
                    <span class="span3-7">Flyme 9 功能视频</span>
                </a>
            </div>
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/05shipin/006.jpg" alt="" width="262.5px" >
                    <span class="span3-7">Flyme 8 概念视频</span>
                </a>
            </div>
            <div class="col-md-3">
                <a href="" >
                    <img src="img/img4/05shipin/007.jpg" alt="" width="262.5px" >
                    <span class="span3-7">Aicy</span>
                </a>
            </div>
            <div class="col-md-3">
                <a href="">
                    <img src="img/img4/05shipin/008.jpg" alt="" width="262.5px" >
